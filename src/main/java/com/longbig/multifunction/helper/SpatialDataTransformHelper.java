...
/**
 * @author yuyunlong
 * @date 2022/2/3 5:17 下午
 * @description 空间数据转换工具类 csv shp GeoJSON 三种格式相互转换
 */
public class SpatialDataTransformHelper {
        ...
        try {
            ...
            if (featureSource instanceof SimpleFeatureStore) {
                ...
                try {
                    ...
                    boolean success = FileUtils.generateCpgFile(shpFile.toString(), StandardCharsets.UTF_8);
                    if (success) {
                        transaction.commit();
                    } else {
